...
<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQP2W43sQXqjQoNnmj6aDfbA09jRQEGFk&libraries=places&callback=initAutocomplete"
      async defer></script>
      <!---<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQP2W43sQXqjQoNnmj6aDfbA09jRQEGFk&libraries=places&callback=initAutocomplete"
      async defer></script>---->
      <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAkKpRyjqDLx90eiy8mxcy02O5_HyFXdf4&libraries=places&callback=initAutocomplete"
        ></script>

<!---<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDQP2W43sQXqjQoNnmj6aDfbA09jRQEGFk&callback=initMap"
type="text/javascript"></script>--->
<!--<script src="https://maps.googleapis.com/maps/api/place/autocomplete/json?input=1600+Amphitheatre&key=AIzaSyDQP2W43sQXqjQoNnmj6aDfbA09jRQEGFk&sessiontoken=1234567890" async defer></script>
